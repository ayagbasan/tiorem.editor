app.controller("rssController", ["$scope", "$rootScope", "CallServiceFactory", function ($scope, $rootScope, CallServiceFactory) {


    log("rssController loaded");


 

    let serviceURL = $rootScope.ENVIRONMENT.WebServiceURL + "rss/";
